...
# Second question on each midpoint panel: tied to the command just lived with, in the voice of the phase.
# Waxing crescent (after stations 1, 5, 9 …) = beginning · waxing gibbous = building ·
# waning gibbous (after the Full Moon) = gratitude · waning crescent (the moon going dark) = release.
MIDPOINT = {
 1: "You began turning at the New Moon. What is the first small sign the turn is real, and where are you still facing the old way?",
 2: "What have you actually left at the shore since the First Quarter? What did you quietly pick back up?",
 3: "Which of your thanks from the Full Moon has already faded? Write it again, and add one you missed.",
 4: "As the moon goes dark, what good did you do this week that no one saw? Was it hidden in humility, or in fear?",
 5: "Which command have you started keeping since the New Moon, and where did you first want to make an exception?",
 6: "Did you go to them? If you did, write what happened. If you did not, what is still in the way?",
 7: "What did you gain by closing the door you named? Thank Him for one person you now see whole.",
 8: "Which yes or no from this moon do you still need to keep, or honestly take back, before the New Moon?",
 9: "Where have you already been asked to go further since the New Moon? What did you give, and what did you count?",
 10: "Have you prayed for them by name since the First Quarter? What happened in you when you did, or what stopped you?",
 11: "Where did you fall short this week and find Him patient anyway? Give thanks for that.",
 12: "What did you do in secret this moon? Leave it hidden, and write only what it did to you.",
 13: "What have you stopped storing up since the New Moon, and what have you started giving away?",
 14: "Look at your calendar since the First Quarter. Where did the kingdom come first, and where did it come last?",
 15: "Whom did you stop judging this week, and what did you see in them once you did? Thank Him for it.",
 16: "What holy thing did you guard well this moon? What can you now let rest?",
 17: "What have you asked for since the New Moon? Write whether you are still knocking, and what you have heard.",
 18: "Name one thing you did for someone since the First Quarter that you would want done for you. Is it becoming a habit?",
 19: "What did the narrow step give back to you? Thank Him for what it cost and what it returned.",
 20: "Which voice will you stop listening to before the New Moon? Write your goodbye to it.",
 21: "Whom have you prayed for since the New Moon? Has anyone been sent, and could it have been you?",
 22: "Where has wisdom protected you since the First Quarter, and where did gentleness cost you something?",
 23: "What fear has shrunk since the Full Moon? Thank Him for what the fear left out.",
 24: "In the quiet at the end of this moon, what do you keep hearing? Write it down before it fades.",
 25: "What burden have you handed Him since the New Moon, and what are you still carrying alone?",
 26: "What have you done to honor your parents, or whoever raised you, since the First Quarter? What is still unsaid?",
 27: "What small good thing has spread in you this week instead? Give thanks for it.",
 28: "As the moon empties, what did denying yourself clear out, and what did it make room for?",
 29: "Since the New Moon, whom have you begun to notice that you used to overlook? What did they teach you?",
 30: "Has the conversation you owe grown easier or harder since the First Quarter? What is the next step?",
 31: "List what you have enough of. Thank Him for each, and end with the one you almost forgot.",
 32: "Before the New Moon, what are you ready to release for good? Write it, then write that it is gone.",
 33: "Which act of faithfulness have you begun since the New Moon, and what has it started to build?",
 34: "Since the First Quarter, where has serving grown easier, and where do you still want to be first?",
 35: "Give thanks for one prayer prayed in the room you set apart. Has the room stayed clear?",
 36: "As this moon ends, what are you still asking for? Write whether your faith grew or thinned, and ask once more.",
 37: "Since the New Moon, whom have you invited in? Who is still waiting at the door?",
 38: "Since the First Quarter, what have you given God first, and what still gets there last?",
 39: "Heart, soul and mind: give thanks for one way you loved Him with each this week.",
 40: "Before the moon goes dark, what do you know about your neighbor now that you did not? What will you carry into the next moon?",
 41: "What have you begun to make ready since the New Moon? What are you still putting off?",
 42: "Since the First Quarter, what have you remembered of Him at ordinary tables?",
 43: "Where did you stay awake with Him this week? Thank Him for the hour you did not sleep through.",
 44: "As this moon closes, whom did you feed, and whom will you feed next?",
 45: "What has it meant, since the New Moon, to be marked as His? Whose first step could you walk beside?",
 46: "Since the First Quarter, what have you passed on, and to whom?",
 47: "Where has strength come that was not yours? Give thanks, and name what you are still waiting for.",
 48: "At the last dark of the year, who walks closer to Him because of you, and whom will you walk with next?",
}
assert sorted(MIDPOINT) == list(range(1, 49))
